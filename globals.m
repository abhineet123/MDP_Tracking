...
% parameters to transition to inactive
...
if exist('train_ratio', 'var')
    ...
    detrac_train_ratio = train_ratio;
else
...
opt.detrac_train_ratio = ones(1, numel(opt.detrac_nums)) * detrac_train_ratio;
opt.detrac_test_ratio = ones(1, numel(opt.detrac_nums)) * detrac_test_ratio;
...
opt.gram_seqs = cat(2, opt.gram_seqs, opt.idot_seqs,...
    opt.detrac_seqs, opt.lost_seqs,opt.isl_seqs,...
    opt.gram_split_seqs);
opt.gram_nums = cat(2, opt.gram_nums, opt.idot_nums,...
    opt.detrac_nums, opt.lost_nums, opt.isl_nums,...
    opt.gram_split_nums);
opt.gram_train_ratio = cat(2, opt.gram_train_ratio,...
    opt.idot_train_ratio, opt.detrac_train_ratio,...
    opt.lost_train_ratio, opt.isl_train_ratio,...
    opt.gram_split_train_ratio);
opt.gram_test_ratio = cat(2, opt.gram_test_ratio, opt.idot_test_ratio,...
    opt.detrac_test_ratio, opt.lost_test_ratio, opt.isl_test_ratio,...
    opt.gram_split_test_ratio);
