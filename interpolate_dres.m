...
if isempty(index) == 0
    ...
    % If the last bounding box in the first set and the first bounding box
    % in the second set differ by more than one frame but not more than
    % 5 frames, then the bounding boxes for all the intermediate frames
